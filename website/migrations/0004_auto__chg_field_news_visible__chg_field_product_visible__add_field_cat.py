...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'News.visible'
        db.alter_column('website_news', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Product.visible'
        db.alter_column('website_product', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Adding field 'Category.url'
        db.add_column('website_category', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Changing field 'Category.visible'
        db.alter_column('website_category', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))


    def backwards(self, orm):
        
        # Changing field 'News.visible'
        db.alter_column('website_news', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Product.visible'
        db.alter_column('website_product', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Deleting field 'Category.url'
        db.delete_column('website_category', 'url')

        # Changing field 'Category.visible'
        db.alter_column('website_category', 'visible', self.gf('django.db.models.fields.BooleanField')())
