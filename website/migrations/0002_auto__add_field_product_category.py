...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_product', 'category', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['website.Category']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.category'
        db.delete_column('website_product', 'category_id')
