...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_category', 'content', self.gf('tinymce.models.HTMLField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.content'
        db.delete_column('website_category', 'content')
