...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Category', fields ['url']
        db.create_unique('website_category', ['url'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Category', fields ['url']
        db.delete_unique('website_category', ['url'])
