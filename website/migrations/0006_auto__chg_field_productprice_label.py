...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductPrice.label'
        db.alter_column('website_productprice', 'label', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'ProductPrice.label'
        db.alter_column('website_productprice', 'label', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'website.productprice': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prices'", 'to': "orm['website.Product']"})
        },
        'website.settings': {
